...
export function Navbar() {
    return (
      <header className="px-4 lg:px-6 h-22 flex items-center border-b border-blue-200 dark:border-blue-800 bg-white dark:bg-gray-800 sticky top-0 z-1000">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          ...
          <a className="text-sm font-medium hover:text-[#5386e4] dark:hover:text-blue-400 transition-colors" href="/members">Nuestro Equipo</a>
        </nav>
      </header>
    );
  }
