...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-green-50 dark:from-blue-900 dark:to-green-900">
      <header className="px-4 lg:px-6 h-14 flex items-center border-b border-blue-200 dark:border-blue-800 bg-white dark:bg-gray-800 sticky top-0 z-50">
        <a className="flex items-center justify-center" href="#">
          <Satellite className="h-6 w-6 mr-2 text-blue-600 dark:text-blue-400" />
          <span className="font-bold text-blue-700 dark:text-blue-300">NicaraoSat</span>
        </a>
        <nav className="ml-auto flex gap-4 sm:gap-6">
          <a className="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="#features">Características</a>
          <a className="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="#benefits">Beneficios</a>
          <a className="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="#technology">Tecnologías</a>
          <a className="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="#about">Acerca de Nosotros</a>
          <a className="text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="#contact">Contáctanos</a>
        </nav>
      </header>
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 relative">
          <img src={miningImage} alt="Mining operation" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                Inteligencia Minera Potenciada por IA
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-200 md:text-xl">
                NicaraoSat integra imágenes satelitales y datos de sensores in situ para una gestión avanzada del medio ambiente y de riesgos en las operaciones mineras.
                </p>
              </div>
              <div className="space-x-4">
                <Button className="bg-white text-blue-600 hover:bg-blue-50 hover:text-black" >Inicia</Button>
                <Button  className="bg-white text-blue-600 hover:bg-blue-50 hover:text-black">Saber más</Button>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="features" ref={featuresRef} className="w-full py-12 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-12 text-blue-700 dark:text-blue-300">
              ...
              {[
                {
                  ...
                  description: "Análisis potenciado por IA para identificar sitios mineros potenciales utilizando imágenes satelitales y datos geológicos."
                },
                {
                  icon: AlertTriangle,
                ...
                <Card key={index} className={`transform transition-all duration-500 ${featuresInView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{ transitionDelay: `${index * 100}ms` }}>
                  <CardHeader>
                    <feature.icon className="h-8 w-8 mb-2 text-blue-600 dark:text-blue-400" />
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
              ...
              <div className={`flex flex-col justify-center space-y-4 transition-all duration-1000 ${benefitsInView ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-blue-700 dark:text-blue-300">Beneficios</h2>
                <ul className="grid gap-6">
                  {[
                    {
                      title: "Mejora en la Toma de Decisiones",
                      description: "Tome decisiones basadas en datos con información completa proveniente de imágenes satelitales y datos de sensores."
                    },
                    {
                    ...
                    <li key={index} className={`transition-all duration-500`} style={{ transitionDelay: `${index * 200}ms` }}>
                      <div className="grid gap-1">
                        <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400">{benefit.title}</h3>
        ...
        <section id="technology" ref={techRef} className="w-full py-12 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-12 text-blue-700 dark:text-blue-300">
              Nuestra Tecnología
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <Card key={index} className={`transform transition-all duration-500 ${techInView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{ transitionDelay: `${index * 100}ms` }}>
                  <CardHeader>
                    <tech.icon className="h-8 w-8 mb-2 text-blue-600 dark:text-blue-400" />
                    <CardTitle className="text-blue-700 dark:text-blue-300">{tech.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className={`flex flex-col items-center space-y-4 text-center transition-all duration-1000 ${aboutInView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="space-y-2">
                ...
                NicaraoSat es un equipo de expertos y apasionados en teledetección, inteligencia artificial y ciencias ambientales. 
                Nuestra misión es revolucionar la industria minera al proporcionar soluciones innovadoras para una extracción de recursos sostenible y responsable.
                </p>
              </div>
